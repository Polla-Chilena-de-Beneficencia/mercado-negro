...
def is_excluded_product_brand(brand_name: str) -> bool:
    normalized_brand = brand_name.strip().upper()
    return normalized_brand in EXCLUDED_PRODUCT_BRANDS or normalized_brand.endswith(" (REG)")
